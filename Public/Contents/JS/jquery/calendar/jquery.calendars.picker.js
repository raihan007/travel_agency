...
(function($) { // Hide scope, no $ conflict
 	...
 	alert('Selected ' + dates);
		...
		_attachments: function(elem, inst) {
			...
			if (!trigger) {
			    ...
			    //inst.trigger = $(trigger).clone().removeAttr('id').addClass(this._triggerClass)
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		...
		_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader, calendar) {
			...
			var selector = '<table><tr><td><select class="' + this._monthYearClass +
			...
			if (yearRange === 'any') {
				selector = '<td><select class="' + this._monthYearClass + ' ' + this._anyYearClass +
				...
				selector = '<td><select class="' + this._monthYearClass +
					'" title="' + inst.options.yearStatus + '">';
